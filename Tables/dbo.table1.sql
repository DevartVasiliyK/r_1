...
EXEC sys.sp_addextendedproperty N'MS_Description', 'fff', 'SCHEMA', N'dbo', 'TABLE', N'table1'
GO

EXEC sys.sp_addextendedproperty N'MS_Description', N'кк', 'SCHEMA', N'dbo', 'TABLE', N'table1', 'CONSTRAINT', N'KEY_table1_column2'
GO

EXEC sys.sp_addextendedproperty N'MS_Description', 'fk', 'SCHEMA', N'dbo', 'TABLE', N'table1', 'CONSTRAINT', N'PK_table1'
GO

EXEC sys.sp_addextendedproperty N'MS_Description', 'ff', 'SCHEMA', N'dbo', 'TABLE', N'table1', 'CONSTRAINT', N'CK_table1'
GO